...
<h3>Split ${transaction[0].type} <small>${group[0].name}</small></h3>
<div class="row">
   <div class="col-lg-12">
        ...
        <div class="panel-body">
           <form method="get" action="/" class="form-horizontal">
                ...
                <fieldset>
            	 ...
            	 <a href="${pageContext.request.contextPath}/groups/${group[0].id}/transactions" class="btn btn-primary pull-right">Submit</a>
           </form>
        </div>
     </div>
   </div>
